...
struct CanvasRenderingContext2D
{
    ...
    void (*clearRect)(CanvasRenderingContext2D *_this, double x, double y, double width, double height);
    void (*fillRect)(CanvasRenderingContext2D *_this, double x, double y, double width, double height);
    void (*strokeRect)(CanvasRenderingContext2D *_this, double x, double y, double width, double height);
    /** @param maxWidth optional parameter. provide a value < 0.0 to ignore this parameter. */
    void (*fillText)(CanvasRenderingContext2D *_this, char *text, double x, double y, double maxWidth);
    /** @param maxWidth optional parameter. provide a value < 0.0 to ignore this parameter. */
    void (*strokeText)(CanvasRenderingContext2D *_this, char *text, double x, double y, double maxWidth);
    /* TextMetrics *(*measureText)(CanvasRenderingContext2D *_this, char *text); */ // that's a whole can of worms
    void (*setLineWidth)(CanvasRenderingContext2D *_this, double value);
    ...
    char *(*getStrokeStyle)(CanvasRenderingContext2D *_this);
    void (*beginPath)(CanvasRenderingContext2D *_this);
    void (*closePath)(CanvasRenderingContext2D *_this);
    void (*moveTo)(CanvasRenderingContext2D *_this, double x, double y);
    void (*lineTo)(CanvasRenderingContext2D *_this, double x, double y);
    void (*bezierCurveTo)(CanvasRenderingContext2D *_this, double cp1x, double cp1y, double cp2x, double cp2y, double x, double y);
    void (*quadraticCurveTo)(CanvasRenderingContext2D *_this, double cpx, double cpy, double x, double y);
    void (*arc)(CanvasRenderingContext2D *_this, double x, double y, double radius, double startAngle, double endAngle);
    void (*arcTo)(CanvasRenderingContext2D *_this, double x1, double y1, double x2, double y2, double radius);
    void (*ellipse)(CanvasRenderingContext2D *_this, double x, double y, double radiusX, double radiusY, double rotation, double startAngle, double endAngle);
    void (*rect)(CanvasRenderingContext2D *_this, double x, double y, double width, double height);
    void (*fill)(CanvasRenderingContext2D *_this);
    void (*stroke)(CanvasRenderingContext2D *_this);
    void (*clip)(CanvasRenderingContext2D *_this);
    int (*isPointInPath)(CanvasRenderingContext2D *_this, double x, double y);
    int (*isPointInStroke)(CanvasRenderingContext2D *_this, double x, double y);
    void (*rotate)(CanvasRenderingContext2D *_this, double angle);
    void (*scale)(CanvasRenderingContext2D *_this, double x, double y);
    void (*translate)(CanvasRenderingContext2D *_this, double x, double y);
    void (*transform)(CanvasRenderingContext2D *_this, double a, double b, double c, double d, double e, double f);
    void (*setTransform)(CanvasRenderingContext2D *_this, double a, double b, double c, double d, double e, double f);
    void (*resetTransform)(CanvasRenderingContext2D *_this);
    void (*setGlobalAlpha)(CanvasRenderingContext2D *_this, double value);
    double (*getGlobalAlpha)(CanvasRenderingContext2D *_this);
    void (*setGlobalCompositeOperation)(CanvasRenderingContext2D *_this, char *value);
    char *(*getGlobalCompositeOperation)(CanvasRenderingContext2D *_this);
    void (*save)(CanvasRenderingContext2D *_this);
    void (*restore)(CanvasRenderingContext2D *_this);
    HTMLCanvasElement *(*getCanvas)(CanvasRenderingContext2D *_this);
};
...
struct HTMLCanvasElement
{
     ...
     */
    int (*getHeight)(HTMLCanvasElement *_this);
    /** 
